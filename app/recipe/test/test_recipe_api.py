...
def image_upload_url(recipe_id):
    """Return URL for recipe imaage upload"""
...
def sample_ingredient(user, name='Rice'):
...
class PrivateRecipeApiTests(TestCase):
    ...
    def retrieve_recipes(self):
        ...
        recipes = Recipe.objects.all().oreder_by('-id')
    ...
    def test_create_recipe_wiht_tags(self):
    ...
    def test_create_recipe_wiht_ingredients(self):
